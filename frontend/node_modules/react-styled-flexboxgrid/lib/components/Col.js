...
var Col = _styledComponents2.default.div.withConfig({
  ...
  return Object.keys(p).filter(function (k) {
    ...
    return (0, _config2.default)(p).media[k](_templateObject, (0, _lodash2.default)(p[k])
  ...
  return Object.keys(p).filter(function (k) {
    ...
    return (0, _config2.default)(p).media[k.replace(/Offset$/, '')](_templateObject2, 100 / (0, _config2.default)(p).gridSize * p[k]);
  });
});
