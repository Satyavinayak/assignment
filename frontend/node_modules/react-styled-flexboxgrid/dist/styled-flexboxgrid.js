...
function makeMedia(media) {
  return function () {
    return styled.css(['@media ', '{', '}'], media, styled.css.apply(undefined, arguments));
  };
}

var _templateObject = taggedTemplateLiteral(['\n        width: ', 'rem;\n      '], ['\n        width: ', 'rem;\n      ']);

var Grid = styled__default.div.withConfig({
  displayName: 'Grid'
})(['margin-right:auto;margin-left:auto;', ' ', ''], function (p) {
  return p.fluid && styled.css(['padding-right:', ';padding-left:', ';'], function (p) {
    return config(p).outerMargin + 'rem';
  }, function (p) {
    return config(p).outerMargin + 'rem';
  });
}, function (p) {
  return !p.fluid && styled.css(['', ''], DIMENSION_NAMES.map(function (t) {
...
var Col = styled__default.div.withConfig({
  displayName: 'Col'
